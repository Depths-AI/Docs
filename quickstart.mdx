...
# If you want to accept OTLP protobuf bodies as well as JSON
...
You can also use the **API Reference** tab in these docs. The Try it button will call your local server at `http://localhost:4318`.
